...
var SoundTouchProcessor = class extends AudioWorkletProcessor {
	...
	constructor() {
		...
		// Speech-tuned stretch parameters (cjm-fasthtml-web-audio patch):
		// sequenceMs=40 (shorter than music auto-mode's 50-125ms) tracks phoneme
		// transitions better; seekWindowMs=15, overlapMs=8 unchanged from WSOLA speech norms.
		this._pipe.stretch.setParameters(sampleRate, 40, 15, 8);
	}
